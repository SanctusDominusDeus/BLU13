...
baseline_columns = ['insulin','A1Cresult','race','max_glu_serum','number_diagnoses','medical_specialty'
,'age','admission_type_code','discharge_disposition_code','gender','admission_source_code','num_medications','readmitted']

cat_cols = ['insulin','A1Cresult','race','max_glu_serum','medical_specialty'
,'age','admission_type_code','discharge_disposition_code','gender','admission_source_code']
